...
router.get("/logs", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN", "LOTTERY_MANAGER"), async (req, res) => {
    try {
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/logs/:id", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/logs/count", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/recent", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/entity/:entity", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/statistics", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
        const startDate = req.query.startDate
            ? new Date(req.query.startDate)
...
// @access  Private (AUDITOR+, SUPER_ADMIN)
router.get("/search", authenticateToken, authorizeRoles("AUDITOR", "SUPER_ADMIN"), async (req, res) => {
    try {
        const { q } = req.query;
        const page = Number(req.query.page) || 1;
        const limit = Number(req.query.limit) || 50;
