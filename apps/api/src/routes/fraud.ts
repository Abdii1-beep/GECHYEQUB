...
router.post(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      const result = await FraudDetectionService.flagAccount(
        userId,
        reason,
        req.userId!,
        severity
...
router.get(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      const result = await FraudDetectionService.getFlaggedAccounts(
        status as string,
        Number(limit),
        Number(offset)
      );
...
router.put(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      const result = await FraudDetectionService.resolveFlag(
        req.params.id,
        resolution,
        req.userId!,
        actionTaken
